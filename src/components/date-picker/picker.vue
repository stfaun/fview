<template>
    <div
        ...
        <transition :name="transition">
            <i-drop v-show="opened" :placement="placement" ref="drop">
                <div ref="picker"></div>
            </i-drop>
        </transition>
    </div>
...
<script>
    ...
    import iDrop from '../../components/select/dropdown.vue';
    import clickoutside from '../../directives/clickoutside';
    import { oneOf } from '../../utils/assist';
    import { formatDate, parseDate } from './util';
    import Emitter from '../../mixins/emitter';

    const prefixCls = 'fv-date-picker';
    ...
    export default {
        name: 'iCalendarPicker',
        mixins: [ Emitter ],
        components: { iInput, iDrop },
...
//                if (!this.disableClickOutSide) this.visible = false;
            ...
            emitChange (date) {
                ...
                this.$nextTick(() => {
                    ...
                    this.dispatch('iFormItem', 'on-form-change', newDate);
                });
            },
            formattingDate (date) {
                const type = this.type;
