        ...
        <div :class="[prefixCls + '-body']">
            <div :class="[prefixCls + '-content', prefixCls + '-content-left']" v-show="!isTime">
                <div :class="[datePrefixCls + '-header']" v-show="leftCurrentView !== 'time'">
                    <span
                        ...
                        @click="prevYear('left')"><i-icon type="ios-arrow-left"></i-icon></span>
                    <span
                        :class="iconBtnCls('prev')"
                        @click="prevMonth"
                        v-show="leftCurrentView === 'date'"><i-icon type="ios-arrow-left"></i-icon></span>
                    <span
                    ...
                    <span
                        ...
                        @click="nextYear('left')"
                        v-show="leftCurrentView === 'year' || leftCurrentView === 'month'"><i-icon type="ios-arrow-right"></i-icon></span>
                </div>
                <i-date-table
                    ...
                    @on-pick-click="handlePickClick"></i-date-table>
                <i-year-table
                    ref="leftYearTable"
                    ...
                    @on-pick-click="handlePickClick"></i-year-table>
                <i-month-table
                    ref="leftMonthTable"
                    ...
                    @on-pick-click="handlePickClick"></i-month-table>
            </div>
            <div :class="[prefixCls + '-content', prefixCls + '-content-right']" v-show="!isTime">
                <div :class="[datePrefixCls + '-header']" v-show="rightCurrentView !== 'time'">
                     <span
                         ...
                         v-show="rightCurrentView === 'year' || rightCurrentView === 'month'"><i-icon type="ios-arrow-left"></i-icon></span>
                    <span
                        :class="[datePrefixCls + '-header-label']"
                    ...
                    <span
                        :class="iconBtnCls('next', '-double')"
                        @click="nextYear('right')"><i-icon type="ios-arrow-right"></i-icon></span>
                    <span
                        :class="iconBtnCls('next')"
                        @click="nextMonth"
                        v-show="rightCurrentView === 'date'"><i-icon type="ios-arrow-right"></i-icon></span>
                </div>
                <i-date-table
            ...
            <div :class="[prefixCls + '-content']" v-show="isTime">
                <i-time-picker
                    ...
                    @on-pick-click="handlePickClick"></i-time-picker>
            </div>
            <i-confirm
                v-if="confirm"
                :show-time="showTime"
                ...
                @on-pick-success="handlePickSuccess"></i-confirm>
        </div>
    </div>
</template>
<script>
    import iIcon from '../../icon/icon.vue';
    import iDateTable from '../base/date-table.vue';
    import iYearTable from '../base/year-table.vue';
    import iMonthTable from '../base/month-table.vue';
    import iTimePicker from './time-range.vue';
    import iConfirm from '../base/confirm.vue';
    import { toDate, prevMonth, nextMonth, initTimeDate } from '../util';

    import Mixin from './mixin';
    import Locale from '../../../mixins/locale';

    const prefixCls = 'fv-picker-panel';
    const datePrefixCls = 'fv-date-picker';

    export default {
        name: 'iDatePicker',
        mixins: [ Mixin, Locale ],
        components: { iIcon, iDateTable, iYearTable, iMonthTable, iTimePicker, iConfirm },
        data () {
            return {
                prefixCls: prefixCls,
