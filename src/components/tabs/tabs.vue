                    ...
                    <div :class="[prefixCls + '-nav-scroll']">
                        <div :class="[prefixCls + '-nav']" ref="nav">
                            ...
                            <div :class="tabCls(item)" v-for="(item, index) in navList" @click="handleChange(index)">
                                <i-icon v-if="item.icon !== ''" :type="item.icon"></i-icon>
                                {{ item.label }}
                                <i-icon v-if="showClose(item)" type="ios-close-empty" @click.native.stop="handleRemove(index)"></i-icon>
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            getTabs () {
                return this.$children.filter(item => item.$options.name === 'iTabPane');
            },
            updateNav () {
                this.navList = [];
