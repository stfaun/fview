<template>
    <div :class="classes" v-clickoutside="handleClose">
        ...
        <transition name="slide-up">
            <i-drop v-show="visible" :placement="placement" ref="dropdown">
    ...
    export default {
        ...
        methods: {
            ...
            removeTag (index) {
                ...
                this.broadcast('iDrop', 'on-update-popper');
            },
        ...
        watch: {
            ...
            visible (val) {
                if (val) {
                    ...
                    this.broadcast('iDrop', 'on-destroy-popper');
                }
            },
            query (val) {
                this.$emit('on-query-change', val);

                if (findComponentDownward(this, 'iOptionGroup')) {
                    this.broadcast('iOptionGroup', 'on-query-change', val);
