    ...
    <div :class="classes" v-clickoutside="handleClose">
        <div :class="[prefixCls + '-rel']" @click="toggleOpen">
            <slot>
                ...
                <i-icon type="ios-close" :class="[prefixCls + '-arrow']" v-show="showCloseIcon" @click.native.stop="clearSelect"></i-icon>
                <i-icon type="arrow-down-b" :class="[prefixCls + '-arrow']"></i-icon>
            </slot>
        </div>
        <transition name="slide-up">
            <i-drop v-show="visible">
                <div>
                    <i-caspanel
                        ref="caspanel"
...
<script>
    ...
    import iCaspanel from './caspanel.vue';
    import clickoutside from '../../directives/clickoutside';
    import { oneOf } from '../../utils/assist';
    import Emitter from '../../mixins/emitter';

    const prefixCls = 'fv-cascader';

    export default {
        name: 'iCascader',
        mixins: [ Emitter ],
        components: { iInput, iDrop, iIcon, iCaspanel },
...
//                this.$broadcast('on-clear');
                this.broadcast('iCaspanel', 'on-clear');
            },
            handleClose () {
                this.visible = false;
            },
