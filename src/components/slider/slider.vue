<template>
    <div :class="classes">
        <i-input-number
            ...
            :value="currentValue"
            :disabled="disabled"
            @on-change="handleInputChange"></i-input-number>
        <div :class="[prefixCls + '-wrap']" ref="slider" @click.self="sliderClick">
            ...
            <template v-if="range">
                <div
                    ...
                    <i-tooltip :controlled="firstDragging" placement="top" :content="tipFormat(currentValue[0])" :disabled="tipDisabled" :always="showTip === 'always'" ref="tooltip">
                ...
                <div
                    ...
                    <i-tooltip :controlled="secondDragging" placement="top" :content="tipFormat(currentValue[1])" :disabled="tipDisabled" :always="showTip === 'always'" ref="tooltip2">
            ...
            <template v-else>
                <div
                    ...
                    <i-tooltip :controlled="dragging" placement="top" :content="tipFormat(currentValue)" :disabled="tipDisabled" :always="showTip === 'always'" ref="tooltip">
...
<script>
    import iInputNumber from '../input-number/input-number.vue';
    import iTooltip from '../tooltip/tooltip.vue';
    import { getStyle, oneOf } from '../../utils/assist';
    import Emitter from '../../mixins/emitter';

    const prefixCls = 'fv-slider';

    export default {
        name: 'iSlider',
        mixins: [ Emitter ],
        components: { iInputNumber, iTooltip },
        props: {
            min: {
                type: Number,
                default: 0
