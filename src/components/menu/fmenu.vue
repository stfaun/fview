    ...
    export default {
        ...
        methods: {
            updateActiveName () {
                ...
                this.broadcast('fSubmenu', 'on-update-active-name', false);
                this.broadcast('fMenuItem', 'on-update-active-name', this.currentActiveName);
            },
            updateOpenKeys (name) {
            ...
            updateOpened () {
                const items = findComponentsDownward(this, 'fSubmenu');
