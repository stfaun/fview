...
<template>
    <div style="margin: 200px 0 0 ">
        <f-select v-model="model1" style="width:500px" filterable multiple>
            <!-- <f-option v-for="item in cityList" :value="item.value" :key="item">{{ item.label }}</f-option> -->
        </f-select>
        {{ model1 }}
        <i-button @click="set">set</i-button>
